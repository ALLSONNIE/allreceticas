...
<body class="container">
     ...
     <header>
        ...
        <nav class="navbar topnav">
         ...
         <div class="row align-menu text-center mt-5">
            <p class="badge badge-pink mb-5 mt-3">Iniciar Sesión</p>

            <div class="mb-5 mt-3 margin-content title-medium text-center">

                <div class="row form-group mt-3">
                    <label for="nombre" class="col-2 d-flex">Nombre de usuario:</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control input-size border-pink ms-5 shadow-lg title-regular" id="nombre" placeholder="usuario">
                    </div>
                ...
                <div class="row form-group mt-5">
                    ...
                    <label for="contraseña" class="col-2 d-flex">Contraseña:</label>
                    <div class="col-sm-10">
                      <input type="password" class="form-control input-size border-pink ms-5 shadow-lg title-regular" id="contraseña" placeholder="**************">
                    </div>
                </div>
            ...
            <div class="text-center mt-2">
                <a class="me-5 d-inline-block btn-circular btn-circular-client mt-5 p-1" href="perfil.php">Iniciar sesión</a>
                <a class="d-inline-block btn-circular btn-large mt-5 p-1" href="recuperar-contraseña.html">¿Olvidó su contraseña?</a>
            </div>
